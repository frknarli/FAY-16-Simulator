...
namespace CORG_16_Simulator
{
    ...
    public class LineNumberStrip : Control
    {
        ...
        public LineNumberStrip(RichTextBox plainTextBox)
        {
            ...
            //>>>>>>>>number text rengi
            base.ForeColor = ColorTranslator.FromHtml("#F5AD5B"); //System.Drawing.ColorTranslator.FromHtml("#ddd");
            //>>>>> number text backg renk  
            this.OffsetColor = Color.GhostWhite; //System.Drawing.ColorTranslator.FromHtml("#222E33");       
